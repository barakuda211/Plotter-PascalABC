...
//PlotterWPF{
function PlotterGetDC: DrawingContext;
procedure PlotterInvokeVisual(d: System.Delegate; params args: array of object);

procedure EllipseDC(dc: DrawingContext; x,y,r1,r2: real);
procedure FillEllipseDC(dc: DrawingContext; x,y,r1,r2: real);
procedure DrawEllipseDC(dc: DrawingContext; x,y,r1,r2: real);
procedure RectangleDC(dc: DrawingContext; x,y,w,h: real);
procedure DrawRectangleDC(dc: DrawingContext; x,y,w,h: real);
procedure FillRectangleDC(dc: DrawingContext; x,y,w,h: real);
procedure LineDC(dc: DrawingContext; x,y,x1,y1: real);
procedure TextOutDC(dc: DrawingContext; x, y: real; text: real);

procedure EllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color);
procedure FillEllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color);
procedure DrawEllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color);
procedure RectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color);
procedure DrawRectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color);
procedure FillRectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color);
procedure LineDC(dc: DrawingContext; x,y,x1,y1: real; cl: Color);
//procedure TextOutDC(x, y: real; text: real; c: GColor);
//}
...
//{PlotterWPF
procedure EllipseDC(dc: DrawingContext; x,y,r1,r2: real) := dc.DrawEllipse(Brush.BrushConstruct,Pen.PenConstruct,Pnt(x,y),r1,r2);
procedure FillEllipseDC(dc: DrawingContext; x,y,r1,r2: real) := dc.DrawEllipse(Brush.BrushConstruct,nil,Pnt(x,y),r1,r2);
procedure DrawEllipseDC(dc: DrawingContext; x,y,r1,r2: real) := dc.DrawEllipse(nil,Pen.PenConstruct, Pnt(x,y),r1,r2);
procedure RectangleDC(dc: DrawingContext; x,y,w,h: real):= dc.DrawRectangle(Brush.BrushConstruct, Pen.PenConstruct,rect(x,y,w,h));
procedure DrawRectangleDC(dc: DrawingContext; x,y,w,h: real):= dc.DrawRectangle(nil, Pen.PenConstruct,rect(x,y,w,h));
procedure FillRectangleDC(dc: DrawingContext; x,y,w,h: real) := dc.DrawRectangle(Brush.BrushConstruct, nil, rect(x,y,w,h));
procedure LineDC(dc: DrawingContext; x,y,x1,y1: real) := dc.DrawLine(Pen.PenConstruct, Pnt(x,y), Pnt(x1,y1));
procedure TextOutDC(dc: DrawingContext; x, y: real; text: real);
begin
  var fmt := FormTextFont(''+text,Font);
  dc.DrawText(fmt, Pnt(x,y));
end;

procedure EllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color) := dc.DrawEllipse(GetBrush(cl),Pen.PenConstruct,Pnt(x,y),r1,r2);
procedure FillEllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color) := dc.DrawEllipse(GetBrush(cl),nil,Pnt(x,y),r1,r2);
procedure DrawEllipseDC(dc: DrawingContext; x,y,r1,r2: real; cl: Color) := dc.DrawEllipse(nil,ColorPen(cl),Pnt(x,y),r1,r2);
procedure RectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color):= dc.DrawRectangle(GetBrush(cl), Pen.PenConstruct,rect(x,y,w,h));
procedure DrawRectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color):= dc.DrawRectangle(nil, ColorPen(cl),rect(x,y,w,h));
procedure FillRectangleDC(dc: DrawingContext; x,y,w,h: real; cl: Color) := dc.DrawRectangle(GetBrush(cl), nil, rect(x,y,w,h));
procedure LineDC(dc: DrawingContext; x,y,x1,y1: real; cl: Color) := dc.DrawLine(ColorPen(cl), Pnt(x,y), Pnt(x1,y1));

function PlotterGetDC := GetDc;
procedure PlotterInvokeVisual(d: System.Delegate; params args: array of object):= InvokeVisual(d,args);
//}
